...
const Modifier_Investissement = () => {
  return (
    <div className='MainDiv'>
        <div className="titleoX">
        Modifier Investissement DAD
        </div>
        ...
        <div className="Modifier">
            ...
            < input type='submit' value="Processus d'elaboration"  className='sauvegarder' />
...
export default Modifier_Investissement
